  ...
  return (
    <div className="flex justify-end">
      <button
        ...
        className="flex w-10 h-10 items-center justify-center hover:bg-gray-400 bg-gray-200 text-gray-800 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 font-bold rounded-full"
      >
        {isDarkMode ? (
